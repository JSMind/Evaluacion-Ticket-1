class Validaciones {
    //  Metodo para validar entrada de los campos del formulario de tipo texto
    validarTxt = (texto, tipo) =>{
        try {
    ...
    //Metodo  para validar que los campos no sean vacios
    validarOtros = (datos,tipo) => {
        try {
